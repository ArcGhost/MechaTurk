...
hit_seeds = [
	...
	{'hit_id': '2345678901', 'title': 'Rowan 2016 Baseball Schedule', 'bounty':'7.50', 'worker_id':'ABCDEFGHIJKL','url': 'http://www.rowanathletics.com/schedule.aspx?path=baseball', 'status':'reviewable', 'created_at': dt2, 'school':319, 'deadline':2, 'keywords':'Tassl, alumni, snakes, data collection', 'instructions':'Enter all event info relating to the RussMatt Central Florida Invitational'},
	{'hit_id': '3456789012', 'title': 'Cornell 2015 Basketball Schedule', 'bounty':'6.50', 'worker_id':'BCDEFGHIJKLM','url': 'http://www.cornellbigred.com/schedule.aspx?path=mbball', 'status':'approved', 'created_at': dt3, 'school':319, 'deadline':1, 'keywords':'Tassl, alumni, planes, data collection', 'instructions':'Enter all event info relating to the 2015 season.'}
	]
